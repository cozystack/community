...
**Ship only PostgreSQL and MariaDB and call the API complete.** That leaves operator-issued bundles, private external input, and delivery untested; the first-wave S3, replication, and delivery rows are deliberate acceptance obligations.
